...
cli::cli_ul()
cli::cli_li("Données     : {file.path(.get_project_root(), 'data', 'processed')}")
cli::cli_li("Modèles     : {file.path(.get_project_root(), 'output', 'models')}")
cli::cli_li("Figures     : {file.path(.get_project_root(), 'figures')}")
cli::cli_li("Résultats   : {file.path(.get_project_root(), 'output')}")
cli::cli_end()
